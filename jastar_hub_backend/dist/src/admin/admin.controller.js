...
let AdminController = class AdminController {
    ...
    async makeAdmin(id) {
        return this.usersService.updateUser(id, { role: client_1.Role.ADMIN });
    }
    async getLeaderboard() {
        return this.usersService.getLeaderboard();
    }
    async getPendingEvents() {
        return this.eventsService.findAll({ where: { status: client_1.EventStatus.PENDING } });
    }
...
__decorate([
    (0, common_1.Patch)('events/moderate/:id'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)('status')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", Promise)
], AdminController.prototype, "moderateEvent", null);
